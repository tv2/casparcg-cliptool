...
import { AmpMessage, ChannelStatus } from './Interfaces'

export function readAmpMessage(message: string): AmpMessage {
...
export function statusSenseResponse(status: ChannelStatus) {
    let response = '7f20'
